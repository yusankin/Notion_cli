...
from src.response_parser import extract_titles_from_response
import requests
...
def test_extract_titles_from_response():
    mock_response_data = {
        "object": "list",
        "results": [
            {
    ...
    result = extract_titles_from_response(mock_response_data)
